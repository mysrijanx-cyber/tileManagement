...
// ✅ FIXED: Price can be string or number during form input
export interface CreatePlanData {
  plan_name: string;
  price: number | string;  // ✅ Allow both for form handling
  currency: string;
  billing_cycle: 'monthly' | 'yearly';
...
console.log('✅ Plan Types loaded - v4.0 (Production Ready - Price Type Fixed)');