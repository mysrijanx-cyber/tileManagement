...
// //     // Check if limit exceeded (overflow)
// //     // ✅ This logic is correct (e.g. if newCount is 6 and maxScans is 5, it triggers block)
// //     const limitExceeded = maxScans !== -1 && newCount > maxScans;
...
// //       await updateDoc(subsRef, {
// //         current_scan_count: maxScans, // Ensures it caps exactly at the max value
// //         last_scan_at: new Date().toISOString(),
// //         status: 'completed',
// //         completed_at: new Date().toISOString(),
// //         completion_reason: 'scan_limit_exceeded',
...
// //     } else {
// //       // Within limit or exactly at limit (e.g. 5/5 allowed to proceed safely)
// //       console.log('✅ [INCREMENT] Within limit - Saving count');
...
// // // ═══════════════════════════════════════════════════════════════
// // // ✅ GET REMAINING SCANS - PRODUCTION READY
// // // ═══════════════════════════════════════════════════════════════
...
// //     // ✅ CRITICAL FIX: Evaluates strictly to greater than (>)
// //     const limitReached = used > maxScans;
...
// // console.log('✅ Subscription Service loaded - PRODUCTION FINAL (STRICT ATTEMPT LIMIT FIX)'); 
// import {
//   collection,
//   doc,
//   getDoc,
...
//     try {
//       // ✅ CRITICAL FIX: Status array mein ['active', 'pending', 'completed'] teeno include kiye hain
//       // Isse purani expired ya completed subscription ka track miss nahi hoga jab tak naya plan link ho raha ho
//       const q = query(
//         // collection(db, 'subscriptions'),
//         // where('seller_id', '==', sellerId),
...
//         collection(db, 'subscriptions'),
//   where('seller_id', '==', sellerId),
//   where('status', '==', 'active'), // 👈 Strictly look for what is valid now
//   orderBy('created_at', 'desc'),
//   limit(1)
//       );
...
//         const activeSubscriptions = subscriptions.filter(sub => 
//           sub.status === 'active' || sub.status === 'pending' || sub.status === 'completed'
//         );
...
//   // ✅ Status control mechanism handles explicit cancellations or replacements
...
//   // ✅ STRICT OPERATOR: Checks overflow strictly at > (e.g. 3rd attempt if limit is 2)
...
//     // ✅ STRICT LIMIT ATTEMPT EVALUATION
//     // Agar limit 2 hai aur newCount 3 hone laga, toh 3rd attempt block hoga.
...
//     // Save current successful increment count (2nd scan saves as 2 successfully here)
//     const updateData: any = {
//       current_scan_count: newCount,
//       scan_limit: maxScans,
//       last_scan_at: new Date().toISOString(),
...
//     // ✅ STRICT EVALUATION OVERFLOW CHECK: Strict boundary configuration (> instead of >=)
//     const limitReached = used > maxScans;
