    ...
    return (
      <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-5 lg:p-6">
        <div className="text-center py-6 sm:py-8">
          <Palette className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 text-gray-300 mx-auto mb-3 sm:mb-4" />
          <div className="space-y-2">
            <p className="text-sm sm:text-base text-gray-500 font-medium">Get Started</p>
