...
// import { Bell, Check, X, Clock, Eye, User, Mail, Phone, MapPin, Store } from 'lucide-react';
...
//       {/* Dropdown Panel */}
//       {showDropdown && (
//         <div className="absolute right-0 mt-2 w-[420px] bg-white rounded-xl shadow-xl border border-gray-200 z-50 max-h-[500px] overflow-hidden">
...
//                 <p className="text-sm">New seller requests will appear here</p>
//               </div>
//             )}
//           </div>
