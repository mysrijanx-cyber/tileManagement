...
// // // // ═══════════════════════════════════════════════════════════════
// // // // ✅ CREATE PLAN MODAL - PRODUCTION v2.0
// // // // Dynamic Features + Clean UI
// // // // ═══════════════════════════════════════════════════════════════
...
// // //     setFormData(prev => ({
// // //       ...prev,
// // //       features: [...prev.features, { title: '', description: '', included: true, icon: '' }]
// // //     }));
// // //   };

// // //   const removeFeature = (index: number) => {
// // //     if (formData.features.length <= 1) {
// // //       alert('⚠️ At least one feature is required');
// // //       return;
// // //     }
// // //     setFormData(prev => ({
// // //       ...prev,
...
// // //                     ✨ Plan Features
// // //                     <span className="text-xs text-gray-500 font-normal">({formData.features.length} feature{formData.features.length !== 1 ? 's' : ''})</span>
// // //                   </h3>
// // //                   <button
// // //                     type="button"
// // //                     onClick={addFeature}
// // //                     className="bg-green-600 text-white px-3 py-1.5 rounded-lg hover:bg-green-700 transition-colors text-sm font-medium flex items-center gap-1.5"
// // //                   >
...
// // //                 <div className="space-y-3 sm:space-y-4">
// // //                   {formData.features.map((feature, index) => (
// // //                     <div key={index} className="bg-white border-2 border-gray-200 rounded-lg p-3 sm:p-4 hover:border-purple-300 transition-colors">
// // //                       <div className="flex items-center justify-between mb-3">
...
// // //                       type="button"
// // //                       onClick={addFeature}
// // //                       className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors text-sm font-medium inline-flex items-center gap-2"
// // //                     >
// // //                       <Plus className="w-4 h-4" />
// // //                       Add First Feature
// // //                     </button>
...
// // //                 onClick={onClose}
// // //                 disabled={creating}
// // //                 className="w-full sm:w-auto px-6 py-3 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 font-medium text-sm sm:text-base transition-colors disabled:opacity-50"
// // //               >
// // //                 Cancel
// // //               </button>
// // //               <button
// // //                 type="submit"
// // //                 disabled={creating}
// // //                 className="w-full sm:w-auto flex-1 px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-medium disabled:opacity-50 text-sm sm:text-base transition-colors"
// // //               >
// // //                 {creating ? (
// // //                   <div className="flex items-center justify-center gap-2">
// // //                     <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
...
// // // console.log('✅ CreatePlanModal Component loaded - PRODUCTION v2.0'); 
// // import React, { useState } from 'react';
// // import { X, Clock, Plus, Trash2 } from 'lucide-react';
// // import { createPlan, validatePlanData } from '../../lib/planService';
// // import type { CreatePlanData, PlanFeature, PlanValidationError } from '../../types/plan.types';
...
// //   // Insert new feature after specific index
...
// //     // Validate price
// //     if (!formData.price || formData.price === '' || parseFloat(formData.price as any) < 0) {
...
// //     const validationErrors = validatePlanData(planDataToSubmit);
// //     if (Object.keys(validationErrors).length > 0) {
// //       setErrors(validationErrors);
// //       alert('❌ Please fix validation errors');
// //       return;
...
// //     try {
// //       const result = await createPlan(planDataToSubmit);
...
// //               {/* ═══════════════════════════════════════════════════════════ */}
// //               {/* PLAN FEATURES - WITH INLINE ADD BUTTONS */}
// //               {/* ═══════════════════════════════════════════════════════════ */}
// //               <div className="bg-gray-50 rounded-xl p-3 sm:p-4 border border-gray-200">
// //                 <div className="mb-4">
// //                   <h3 className="font-semibold text-gray-800 text-sm sm:text-base flex items-center gap-2">
...
// //                     <span className="font-medium text-purple-600">Minimum 1 required</span> • Click + below each feature to add more
// //                   </p>
// //                 </div>
...
// //                       {/* Add Feature Button Below Each Feature */}
// //                       <div className="flex justify-center -mt-2 mb-2">
// //                         <button
// //                           type="button"
// //                           onClick={() => addFeatureAfter(index)}
// //                           className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95 flex items-center gap-2 text-sm font-medium"
// //                           title="Add feature below this one"
// //                         >
// //                           <Plus className="w-4 h-4" />
// //                           Add Feature Below
// //                         </button>
...
// //                 className="w-full sm:w-auto flex-1 px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 font-medium disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base transition-all shadow-md hover:shadow-lg active:scale-95"
// //               >
// //                 {creating ? (
// //                   <div className="flex items-center justify-center gap-2">
// //                     <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
...
// // console.log('✅ CreatePlanModal - PRODUCTION v5.0 (Inline Add Feature • Blank Price • Perfect UX)'); 
// import React, { useState } from 'react';
// import { X, Clock, Plus, Trash2 } from 'lucide-react';
// import { createPlan, validatePlanData } from '../../lib/planService';
// import type { CreatePlanData, PlanFeature, PlanValidationError } from '../../types/plan.types';
...
//               {/* ═══════════════════════════════════════════════════════════ */}
//               {/* PLAN FEATURES - ONLY LAST FEATURE SHOWS ADD BUTTON */}
//               {/* ═══════════════════════════════════════════════════════════ */}
//               <div className="bg-gray-50 rounded-xl p-3 sm:p-4 border border-gray-200">
//                 <div className="mb-4">
//                   <h3 className="font-semibold text-gray-800 text-sm sm:text-base flex items-center gap-2">
...
//                   </h3>
//                   <p className="text-xs text-gray-500 mt-1">
//                     <span className="font-medium text-purple-600">Minimum 1 required</span> • Click + below last feature to add more
//                   </p>
//                 </div>
...
//                       {/* Add Feature Button - ONLY SHOW FOR LAST FEATURE */}
...
// console.log('✅ CreatePlanModal - PRODUCTION FINAL (Only Last Feature Shows Add Button • Perfect UX)'); 
console.log('✅ CreatePlanModal - PRODUCTION v6.0 (Min 1 Feature • Unlimited Features • Price Fixed)');
