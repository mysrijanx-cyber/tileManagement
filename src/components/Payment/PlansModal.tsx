...
//   onClose: () => void;
//   sellerId: string;
//   userToken: string;        // ✅ Add this prop
...
//   onClose,
//   sellerId,
//   userToken,      // ✅ Props se lo
//   isLoggedIn      // ✅ Props se lo
// }) => {
//   // ❌ Remove useAuth
...
//   // ❌ Remove token fetching useEffect
//   // No need - token already in props
...
//         console.log(`✅ Fetched ${activePlans.length} active plans`);
...
//                 <p className="text-purple-100 text-sm">Select the perfect plan for your business</p>
//               </div>
//               <button
//                 onClick={onClose}
...
//                 <h3 className="text-xl font-bold text-orange-800 mb-2">Please Login</h3>
//                 <p className="text-orange-700">You must be logged in to purchase a plan.</p>
//               </div>
//             )}
...
//                     key={plan.id}
//                     plan={plan}
//                     sellerId={sellerId}           // ✅ Pass from props
//                     userToken={userToken}         // ✅ Pass from props
//                     isLoggedIn={isLoggedIn}       // ✅ Pass from props
...
// console.log('✅ PlansModal - v7.0 (Props-based, No useAuth)'); 
// ═══════════════════════════════════════════════════════════════
// ✅ PLANS MODAL - PRODUCTION v8.0 - AUTO-CLOSE ON PAYMENT SUCCESS
// ═══════════════════════════════════════════════════════════════
            ...
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-3xl font-bold mb-1">
                  {paymentSuccessDetected ? '✅ Payment Successful!' : 'Choose Your Plan'}
                </h2>
