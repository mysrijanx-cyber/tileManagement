...
// import { X } from 'lucide-react'; // ✅ FIXED: Removed unused imports
...
//                   💎 Choose Your Plan For Your Tile <br />Virtualization Platform
//                 </h2>
...
//                 <h3 className="text-base sm:text-lg font-semibold text-red-800 mb-2">Error Loading Plans</h3>
...
//                 <h3 className="text-base sm:text-lg font-semibold text-gray-700 mb-2">No Plans Available</h3>
//                 <p className="text-sm sm:text-base text-gray-600">Plans are currently being configured. Please check back later.</p>
//               </div>
//             ) : (
//               <>
...
//                       <h4 className="font-semibold text-gray-800 text-xs sm:text-sm mb-1">Secure Payment</h4>
//                       <p className="text-xs text-gray-600">Razorpay encrypted checkout</p>
//                     </div>
//                     <div>
//                       <div className="text-xl sm:text-2xl mb-2">📧</div>
//                       <h4 className="font-semibold text-gray-800 text-xs sm:text-sm mb-1">Instant Activation</h4>
//                       <p className="text-xs text-gray-600">Access immediately after payment</p>
//                     </div>
//                     <div>
//                       <div className="text-xl sm:text-2xl mb-2">🎧</div>
//                       <h4 className="font-semibold text-gray-800 text-xs sm:text-sm mb-1">24/7 Support</h4>
...
//                 {!isLoggedIn && (
//                   <div className="mt-4 sm:mt-6 bg-yellow-50 border border-yellow-200 rounded-xl p-3 sm:p-4 text-center">
...
// console.log('✅ PlansModal Component loaded - PRODUCTION v3.0 (FIXED)'); 
// ═══════════════════════════════════════════════════════════════
// ✅ PLANS MODAL - PRODUCTION READY v4.0 - FULLY RESPONSIVE
// ═══════════════════════════════════════════════════════════════
