...
//       alert(`📥 Excel Downloaded!\n\n📊 ${uploadedImages.length} tiles ready\n\nNext Steps:\n1. Open Excel\n2. Fill: Tile Name, Size, Price, Quantity\n3. Save file\n4. Upload in "Process Excel" section`);
...
//                     <li><strong>Fill Details:</strong> Open Excel → Add name, size, price, quantity</li>
...
//                           Excel file with URLs pre-filled. Add tile details and upload in "Process Excel" tab!
//                         </p>
//                         <button
...
//                   <li>Fill: <strong>Tile Name</strong>, <strong>Size</strong>, <strong>Price</strong>, <strong>Quantity</strong></li>
...
//                     <p><strong>Required Columns:</strong> Tile Name, Tile URL, Size, Code, Price, Quantity</p>
//                   </div>
//                   <div className="flex items-start gap-2">
//                     <span className="bg-blue-100 text-blue-600 rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold flex-shrink-0">✓</span>
