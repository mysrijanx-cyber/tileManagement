...
//         <span className="text-sm text-purple-600 font-medium">Total Plans</span>
//       </div>
...
//         <span className="text-sm text-orange-600 font-medium">Avg Days</span>
//       </div>
//       <p className="text-2xl font-bold text-orange-900 mt-1">
//         {stats.average_plan_duration || 0}
//       </p>
//     </div>
//   </div>
// )}
...
//                   <tr>
//                     <th className="text-left px-6 py-4 font-semibold text-gray-700">Plan Details</th>
//                     <th className="text-left px-6 py-4 font-semibold text-gray-700">Purchase Date</th>
//                     <th className="text-left px-6 py-4 font-semibold text-gray-700">Expiry Date</th>
...
//                         <div>
//                           <div className="font-semibold text-gray-900">{item.plan_name}</div>
...
//                       <td className="px-6 py-4">
//                         <div>
//                           <div className="font-medium text-gray-900">{item.purchased_date}</div>
//                           <div className="text-sm text-gray-600">{item.purchased_time}</div>
//                           <div className="text-xs text-gray-500">{item.purchased_day}</div>
//                         </div>
//                       </td>
//                       <td className="px-6 py-4">
//                         <div>
//                           <div className="font-medium text-gray-900">{item.expired_date}</div>
//                           <div className="text-sm text-gray-600">{item.expired_time}</div>
//                           <div className="text-xs text-gray-500">{item.expired_day}</div>
//                         </div>
//                       </td>
//                       <td className="px-6 py-4">
...
//                             {item.validity_duration} {item.validity_unit}
//                           </div>
//                         </div>
//                       </td>
//                       <td className="px-6 py-4">
...
//                             <div>
//                               <div className="font-medium text-gray-900">
//                                 {item.total_scans_used || 0} / {item.scan_limit || 0}
//                               </div>
//                               <div className="text-gray-600">scans used</div>
//                             </div>
//                           )}
//                         </div>
//                       </td>
...
//                   <div>
//                     <h4 className="font-semibold text-gray-900">{item.plan_name}</h4>
//                     <p className="text-sm text-gray-600">₹{item.plan_price.toLocaleString()}</p>
//                   </div>
...
//                     <div className="font-medium">{item.purchased_date}</div>
//                     <div className="text-xs text-gray-500">{item.purchased_day}</div>
//                   </div>
//                   <div>
//                     <div className="text-gray-600">Expires</div>
//                     <div className="font-medium">{item.expired_date}</div>
//                     <div className="text-xs text-gray-500">{item.expired_day}</div>
//                   </div>
//                 </div>
...
//                     <span className="font-medium">{item.total_days} days</span>
//                   </div>
//                   <div>
//                     {item.scan_limit === -1 ? (
//                       <span className="text-green-600 font-medium">Unlimited scans</span>
//                     ) : (
//                       <span className="text-gray-600">
//                         {item.total_scans_used || 0} / {item.scan_limit || 0} scans
//                       </span>
//                     )}
//                   </div>
//                 </div>
...
// console.log('✅ HistoryTab Component loaded - Production v1.0'); 
import React, { useState, useEffect } from 'react';
import {
  Clock,
  Package,
