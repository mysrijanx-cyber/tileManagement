...
// // ✅ PRODUCTION v6.0 - PERFECT STATUS BADGES + FULLY RESPONSIVE
// import React, { useState, useEffect, useMemo, useCallback } from 'react';
// import {
//   Clock,
//   Package,
...
//   // ═══════════════════════════════════════════════════════════════
//   // ✅ NEW: CALCULATE ACTUAL STATUS (ACTIVE/EXPIRED)
//   // ═══════════════════════════════════════════════════════════════
...
//       // Parse expired_date - handle multiple formats
//       let expiryDate: Date;
      
//       if (item.expired_date.includes('/')) {
//         // Format: "25/01/2025"
//         const [day, month, year] = item.expired_date.split('/');
//         expiryDate = new Date(`${year}-${month}-${day}`);
//       } else if (item.expired_date.includes('-')) {
//         // Format: "2025-01-25" or "25-01-2025"
//         const parts = item.expired_date.split('-');
//         if (parts[0].length === 4) {
//           expiryDate = new Date(item.expired_date);
//         } else {
...
//         console.warn('Invalid expiry date for item:', item.plan_name, item.expired_date);
//         return 'expired';
//       }
      
//       // Set expiry date to end of day for fair comparison
...
//       // Check original status - only active if not yet expired
//       if (item.status === 'active') {
//         return 'active';
//       }
      
//       // Treat completed/cancelled as expired
...
//     } catch (error) {
//       console.error('Error calculating status for item:', item.plan_name, error);
//       return 'expired';
//     }
//   }, []);
...
// console.log('✅ HistoryTab Component loaded - PRODUCTION v6.0 (PERFECT STATUS BADGES + FULLY RESPONSIVE)'); 
// ✅ PRODUCTION v8.0 - BULLETPROOF ACTIVE/EXPIRED DETECTION
import React, { useState, useEffect, useMemo, useCallback } from 'react';
import {
  Clock,
  Package,
