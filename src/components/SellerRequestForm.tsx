          ...
          <div className="max-w-md mx-auto space-y-6">
            <div className="space-y-2">
              <button 
                ...
                className="block w-full text-left text-gray-600 text-[16px] font-medium p-3 hover:bg-gray-50 rounded-xl transition-colors"
              >
                Product
              </button>
              <button 
              ...
              <div className="text-gray-900 text-[16px] font-semibold p-3 bg-blue-50 rounded-xl">
            ...
            <div className="pt-4 border-t border-gray-100 space-y-3">
              ...
              <button
                onClick={() => { setMobileMenuOpen(false); navigate('/'); }}
                className="w-full bg-[#0040DF] text-white text-[16px] py-3 px-6 rounded-xl font-semibold hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/30 flex items-center justify-center gap-2"
              >
                <X className="w-4 h-4" />
                Close Form
              </button>
