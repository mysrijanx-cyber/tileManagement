// // // src/components/LuxuryDrawingRoomScene.tsx
...
// //   // ============================================
// //   // FLOOR (Glossy White Marble)
// //   // ============================================
  
// //   const FloorComponent = useMemo(() => {
// //     const material = floorTexture 
// //       ? (() => {
// //           const mat = Materials.whiteMarble();
...
// //         <planeGeometry args={[roomWidth, roomDepth, 128, 128]} />
...
// //       {/* Linear LED strip (ceiling centerline) */}
// //       <mesh position={[0, roomHeight - 0.05, 0]} castShadow>
// //         <boxGeometry args={[0.08, 0.02, roomDepth * 0.8]} />
...
// //       {/* LED glow effect */}
// //       <pointLight position={[0, roomHeight - 0.1, 0]} intensity={3} distance={6} color="#ffcc88" />
// //       <pointLight position={[0, roomHeight - 0.1, 2]} intensity={3} distance={6} color="#ffcc88" />
// //       <pointLight position={[0, roomHeight - 0.1, -2]} intensity={3} distance={6} color="#ffcc88" />
// //     </group>
// //   );
...
// //       {/* Venetian blinds (simplified) */}
// //       {Array.from({ length: 40 }).map((_, i) => (
// //         <mesh 
// //           key={`blind-${i}`} 
// //           position={[0.02, 1.2 - (i * 0.06), 0]} 
...
// //   // ============================================
// //   // PLUSH LOUNGE CHAIR (Ribbed Texture)
// //   // ============================================
...
// //         <boxGeometry args={[0.9, 0.75, 0.85]} />
// //         <primitive object={Materials.creamFabric()} attach="material" />
// //       </mesh>
      
// //       {/* Backrest (curved effect with segments) */}
// //       {Array.from({ length: 8 }).map((_, i) => (
// //         <mesh 
// //           key={i} 
// //           position={[0, 0.85 + i * 0.08, -0.35 + i * 0.02]} 
// //           castShadow
// //         >
...
// //         <mesh 
// //           key={`rib-${i}`} 
// //           position={[-0.4 + i * 0.1, 0.5, 0.05]} 
// //           castShadow
// //         >
// //           <boxGeometry args={[0.08, 0.7, 0.02]} />
// //           <meshStandardMaterial color="#efefef" roughness={0.85} />
// //         </mesh>
// //       ))}
...
// //         <boxGeometry args={[3.2, 0.15, 0.45]} />
// //         <primitive object={Materials.lightOakWood()} attach="material" />
// //       </mesh>
      
// //       {/* Backlit LED strip under console */}
// //       <mesh position={[0, 0.52, -0.1]}>
// //         <boxGeometry args={[3.15, 0.02, 0.4]} />
// //         <meshStandardMaterial 
// //           color="#ffaa44" 
// //           emissive="#ffaa44" 
...
// //       {/* LED glow lights */}
// //       <pointLight position={[-1.2, 0.55, -0.1]} intensity={2} distance={1.5} color="#ffcc88" />
// //       <pointLight position={[0, 0.55, -0.1]} intensity={2} distance={1.5} color="#ffcc88" />
// //       <pointLight position={[1.2, 0.55, -0.1]} intensity={2} distance={1.5} color="#ffcc88" />
      
// //       {/* Decorative items on console */}
// //       {/* Black ceramic vase */}
// //       <mesh position={[-1.2, 0.75, -0.1]} castShadow>
// //         <cylinderGeometry args={[0.08, 0.1, 0.25, 16]} />
// //         <primitive object={Materials.blackMatte()} attach="material" />
// //       </mesh>
      
// //       {/* Dry stems */}
// //       {[-0.03, 0, 0.03].map((offset, i) => (
// //         <mesh key={i} position={[-1.2 + offset, 1.05, -0.1]} castShadow>
...
// //       {/* Books stack */}
// //       {[0, 0.04, 0.08].map((y, i) => (
// //         <mesh key={i} position={[0.5, 0.68 + y, -0.15]} castShadow>
...
// //   // ============================================
// //   // LARGE BLACK MODULAR SOFA
// //   // ============================================
  
// //   const ModularSofa = () => (
// //     <group position={[0, 0, 2]}>
// //       {/* Main base (cloud-like, low-height) */}
// //       <mesh position={[0, 0.35, 0]} castShadow receiveShadow>
// //         <boxGeometry args={[3.5, 0.7, 1.2]} />
// //         <primitive object={Materials.blackMatte()} attach="material" />
// //       </mesh>
      
// //       {/* Soft rounded cushions */}
// //       {[-1.2, -0.4, 0.4, 1.2].map((x, i) => (
// //         <mesh key={i} position={[x, 0.75, 0]} castShadow>
// //           <boxGeometry args={[0.7, 0.25, 1.1]} />
...
// //         <boxGeometry args={[3.5, 0.8, 0.25]} />
// //         <primitive object={Materials.blackMatte()} attach="material" />
// //       </mesh>
      
// //       {/* Armrests */}
// //       <mesh position={[-1.7, 0.6, 0]} castShadow receiveShadow>
// //         <boxGeometry args={[0.25, 0.9, 1.2]} />
// //         <primitive object={Materials.blackMatte()} attach="material" />
// //       </mesh>
// //       <mesh position={[1.7, 0.6, 0]} castShadow receiveShadow>
// //         <boxGeometry args={[0.25, 0.9, 1.2]} />
...
// //       {/* Throw pillows */}
// //       {[-0.8, 0.8].map((x, i) => (
// //         <mesh key={i} position={[x, 0.95, -0.3]} castShadow>
...
// //   // ============================================
// //   // WALL PANEL BEHIND SOFA
// //   // ============================================
  
// //   const SofaBackPanel = () => (
// //     <group position={[0, 1.4, 2.65]}>
// //       {/* Matte white grid panels */}
...
// //         <mesh key={`vline-${i}`} position={[-1 + x, 0, 0.03]}>
// //           <boxGeometry args={[0.015, 1.58, 0.01]} />
// //           <meshStandardMaterial color="#e0e0e0" />
// //         </mesh>
// //       ))}
      
// //       {[-0.4, 0, 0.4].map((y, i) => (
// //         <mesh key={`hline-${i}`} position={[-1, y, 0.03]}>
// //           <boxGeometry args={[1.78, 0.015, 0.01]} />
// //           <meshStandardMaterial color="#e0e0e0" />
// //         </mesh>
// //       ))}
      
// //       {/* Vertical ribbed beige strip */}
// //       <mesh position={[0.2, 0, 0]} castShadow>
// //         <boxGeometry args={[0.35, 1.6, 0.04]} />
// //         <primitive object={Materials.beigePanel()} attach="material" />
// //       </mesh>
      
// //       {/* Ribs */}
// //       {Array.from({ length: 20 }).map((_, i) => (
// //         <mesh key={i} position={[0.2, -0.75 + i * 0.08, 0.025]}>
// //           <boxGeometry args={[0.32, 0.03, 0.01]} />
// //           <meshStandardMaterial color="#d4c4b0" roughness={0.7} />
// //         </mesh>
// //       ))}
      
// //       {/* Floating black shelf */}
...
// //       {/* Books on shelf */}
// //       {[0, 0.15].map((x, i) => (
// //         <mesh key={i} position={[0.85 + x, 0.45, 0]} castShadow>
// //           <boxGeometry args={[0.12, 0.18, 0.2]} />
// //           <meshStandardMaterial 
// //             color={i === 0 ? '#4a4a4a' : '#6a6a6a'} 
// //             roughness={0.6}
// //           />
// //         </mesh>
// //       ))}
...
// //   // ============================================
// //   // ARTWORK WALL (Fabric Texture Frames)
// //   // ============================================
...
// //       {/* Pastel blocks in artwork */}
// //       <mesh position={[0.04, 0.6, -0.15]}>
// //         <planeGeometry args={[0.5, 0.3]} />
// //         <meshStandardMaterial color="#c8a882" roughness={0.95} />
// //       </mesh>
// //       <mesh position={[0.04, 0.2, 0.15]}>
// //         <planeGeometry args={[0.5, 0.3]} />
// //         <meshStandardMaterial color="#b87a5a" roughness={0.95} />
// //       </mesh>
...
// //       </mesh>
// //       <mesh position={[0.04, -1.0, 0.15]}>
// //         <planeGeometry args={[0.5, 0.3]} />
// //         <meshStandardMaterial color="#c49b7a" roughness={0.95} />
// //       </mesh>
// //     </group>
// //   );
...
// //       </mesh>
// //       <mesh position={[0, 0.57, 0.05]} castShadow>
...
// //   // ============================================
// //   // GLASS-FRAMED PLANT STRUCTURE
// //   // ============================================
  
// //   const DecorativePlantStructure = () => (
...
// //         [0, 2, 0.3], [0, 2, -0.3], [0.3, 2, 0], [-0.3, 2, 0]
// //       ].map((pos, i) => (
// //         <mesh key={i} position={pos as [number, number, number]}>
// //           <cylinderGeometry args={[0.015, 0.015, i < 4 ? 2 : 0.6, 8]} />
// //           <primitive object={Materials.blackMatte()} attach="material" />
// //         </mesh>
// //       ))}
...
// //   // ============================================
// //   // TALL GLASS VASE WITH PLANT (Near Chair)
// //   // ============================================
...
// //       {/* Thin airy plant stems */}
// //       {[-0.02, 0, 0.02].map((offset, i) => (
// //         <mesh key={i} position={[offset, 0.65, 0]}>
// //           <cylinderGeometry args={[0.003, 0.003, 0.7, 6]} />
// //           <meshStandardMaterial color="#4a5a3a" roughness={0.7} />
// //         </mesh>
// //       ))}
      
// //       {/* Small leaves at top */}
// //       {[0.9, 0.95, 1.0].map((y, i) => (
// //         <mesh key={i} position={[0.02, y, 0]} rotation={[0, i * 0.5, 0]}>
// //           <boxGeometry args={[0.08, 0.12, 0.01]} />
// //           <meshStandardMaterial color="#5a7a4a" roughness={0.6} />
// //         </mesh>
// //       ))}
// //     </group>
// //   );
...
// //       {/* Main directional sunlight from window */}
// //       <directionalLight
// //         position={[8, 6, 2]}
// //         intensity={2.5}
// //         color="#fff8f0"
...
// //       {/* Fill lights (soft, no shadows) */}
// //       <pointLight position={[-3, 2.5, 3]} intensity={1.5} distance={8} color="#fffaf5" />
// //       <pointLight position={[3, 2.5, -3]} intensity={1.5} distance={8} color="#fffaf5" />
// //       <pointLight position={[0, 2.5, 0]} intensity={2} distance={10} color="#fff8f0" />
      
// //       {/* Backlight from window (soft glow) */}
// //       <rectAreaLight
// //         position={[roomWidth / 2 - 0.2, roomHeight / 2, 0]}
// //         width={6}
// //         height={2.4}
// //         intensity={3}
// //         color="#e8f4ff"
...
//       {/* Front wall with DOOR - left section */}
...
//         <boxGeometry args={[1.9, 0.7, 0.02]} />
//         <meshStandardMaterial color="#5a4232" roughness={0.6} />
//       </mesh>
//       <mesh position={[0, -0.6, 0.05]}>
//         <boxGeometry args={[1.9, 0.7, 0.02]} />
//         <meshStandardMaterial color="#5a4232" roughness={0.6} />
...
//       {/* Door handle */}
//       <mesh position={[0.8, 0, 0.1]} castShadow>
//         <cylinderGeometry args={[0.03, 0.03, 0.15, 16]} />
//         <primitive object={Materials.brassMetal()} attach="material" />
//       </mesh>
//       <mesh position={[0.8, 0, 0.08]} rotation={[0, 0, Math.PI / 2]} castShadow>
...
//       {/* LARGE CURTAINS - Left side */}
//       <mesh position={[-0.15, 0.2, -3.2]} rotation={[0, -Math.PI / 2, 0]} castShadow>
//         <planeGeometry args={[1.2, 2.8]} />
//         <primitive object={Materials.creamCurtain()} attach="material" />
//       </mesh>

//       {/* LARGE CURTAINS - Right side */}
//       <mesh position={[-0.15, 0.2, 3.2]} rotation={[0, -Math.PI / 2, 0]} castShadow>
//         <planeGeometry args={[1.2, 2.8]} />
//         <primitive object={Materials.creamCurtain()} attach="material" />
//       </mesh>
...
//       {/* Curtain rod */}
//       <mesh position={[-0.1, 1.6, 0]} rotation={[0, 0, Math.PI / 2]}>
//         <cylinderGeometry args={[0.02, 0.02, 7, 16]} />
//         <primitive object={Materials.brassMetal()} attach="material" />
//       </mesh>

//       {/* Rod end caps */}
//       <mesh position={[-0.1, 1.6, -3.5]}>
...
//       {[0, 0.04, 0.08].map((y, i) => (
//         <mesh key={i} position={[1.2, 0.68 + y, -0.15]} castShadow>
//           <boxGeometry args={[0.15, 0.03, 0.22]} />
//           <meshStandardMaterial 
//             color={['#8b4513', '#654321', '#4a2f1a'][i]} 
//             roughness={0.7}
...
//   // ============================================
//   // BROWN LEATHER SOFA (TV के सामने)
//   // ============================================
  
//   const ModularSofa = () => (
//     <group position={[0, 0, 0.5]} rotation={[0, 0, 0]}>
//       {/* Main base - BROWN COLOR */}
//       <mesh position={[0, 0.35, 0]} castShadow receiveShadow>
//         <boxGeometry args={[3.5, 0.7, 1.2]} />
...
//   // ============================================
//   // COFFEE TABLE (Sofa के सामने - BROWN)
//   // ============================================
...
//         <boxGeometry args={[1.15, 0.02, 0.65]} />
//         <primitive object={Materials.clearGlass()} attach="material" />
//       </mesh>
...
//         [-0.5, 0.3], [0.5, 0.3]
//       ].map(([x, z], i) => (
//         <mesh key={i} position={[x, 0.275, z]} castShadow>
...
//       {/* Magazines */}
//       <mesh position={[0.25, 0.46, 0.1]} castShadow>
//         <boxGeometry args={[0.2, 0.015, 0.28]} />
//         <meshStandardMaterial color="#8b7355" roughness={0.7} />
//       </mesh>
//       <mesh position={[0.27, 0.475, 0.08]} castShadow>
//         <boxGeometry args={[0.19, 0.015, 0.26]} />
//         <meshStandardMaterial color="#6d5d4b" roughness={0.7} />
//       </mesh>
//     </group>
//   );
...
//         <cylinderGeometry args={[0.25, 0.3, 0.4, 24, 1, true]} />
//         <meshStandardMaterial color="#f5f5dc" roughness={0.9} side={THREE.DoubleSide} />
//       </mesh>

//       {/* Light */}
//       <pointLight position={[0, 1.6, 0]} intensity={2} distance={4} color="#fff8e1" />
//     </group>
//   );

//   // ============================================
//   // WALL SHELF WITH DECOR (Side wall)
//   // ============================================
  
//   const WallShelf = () => (
//     <group position={[-roomWidth / 2 + 0.15, 1.8, -1.5]}>
//       {/* Shelf */}
//       <mesh position={[0, 0, 0]} castShadow>
...
//       {/* Items on shelf */}
//       {/* Photo frame */}
//       <mesh position={[0.08, 0.1, -0.4]} castShadow>
...
//       {/* Candle */}
//       <mesh position={[0.08, 0.06, 0.4]} castShadow>
...
//   const ArtworkSection = () => (
//     <group position={[-roomWidth / 2 + 0.05, 1.6, 0]}>
//       {/* Frame 1 */}
//       <mesh position={[0, 0.4, 0]} rotation={[0, Math.PI / 2, 0]} castShadow>
//         <boxGeometry args={[1.2, 0.9, 0.05]} />
//         <primitive object={Materials.blackMatte()} attach="material" />
//       </mesh>
//       <mesh position={[0.03, 0.4, 0]} rotation={[0, Math.PI / 2, 0]}>
//         <planeGeometry args={[1.15, 0.85]} />
//         <meshStandardMaterial color="#d4c4b0" roughness={0.9} />
//       </mesh>
      
//       <mesh position={[0.04, 0.6, -0.15]} rotation={[0, Math.PI / 2, 0]}>
//         <planeGeometry args={[0.5, 0.3]} />
//         <meshStandardMaterial color="#c8a882" roughness={0.95} />
//       </mesh>
//       <mesh position={[0.04, 0.2, 0.15]} rotation={[0, Math.PI / 2, 0]}>
//         <planeGeometry args={[0.5, 0.3]} />
//         <meshStandardMaterial color="#b87a5a" roughness={0.95} />
//       </mesh>
      
//       {/* Frame 2 */}
//       <mesh position={[0, -0.8, 0]} rotation={[0, Math.PI / 2, 0]} castShadow>
//         <boxGeometry args={[1.2, 0.9, 0.05]} />
//         <primitive object={Materials.blackMatte()} attach="material" />
//       </mesh>
//       <mesh position={[0.03, -0.8, 0]} rotation={[0, Math.PI / 2, 0]}>
//         <planeGeometry args={[1.15, 0.85]} />
//         <meshStandardMaterial color="#e8dcc8" roughness={0.9} />
//       </mesh>
...
//         <meshStandardMaterial color="#a67c52" roughness={0.95} />
//       </mesh>
//       <mesh position={[0.04, -1.0, 0.15]} rotation={[0, Math.PI / 2, 0]}>
//         <planeGeometry args={[0.5, 0.3]} />
//         <meshStandardMaterial color="#c49b7a" roughness={0.95} />
//       </mesh>
//     </group>
...
//       <pointLight position={[0, 0.65, 0]} intensity={1} distance={2} color="#fff8e1" />
//     </group>
//   );

//   // ============================================
//   // TALL PLANT (Corner में)
//   // ============================================
