...
// // // Add this import with other component imports (around line 15)
...
// //   // Add this after line: const [showDimensionEditor, setShowDimensionEditor] = useState(false);
// // // Add at top with other imports
...
// //     // Scale existing highlighter counts
// //     if (highlighterBreakdown) {
// //       const visualConfig = VISUAL_CONFIGS[roomType as keyof typeof VISUAL_CONFIGS];
// //       console.log('🔄 Scaling highlighter counts for new dimensions');
      
// //       // Highlighter counts will auto-recalculate on next render
// //     }
...
// //       `Tile counts recalculated.`
// //     );
// //   } else {
// //     setError('Failed to save calculation dimensions');
// //   }
// // }, [roomType, highlighterBreakdown]);
// //   // ═════════════════════════════════════════════════════════════
// //   // EVENT HANDLERS
// //   // ═════════════════════════════════════════════════════════════
...
// // {/* ✅ UPDATED: TILE CALCULATOR SECTION WITH DUAL DIMENSIONS */}
...
// //             <p className="text-[8px] text-gray-400 uppercase tracking-wide">3D Demo Size</p>
// //             <p className="text-white text-[10px] font-semibold">
// //               {VISUAL_CONFIGS[roomType as keyof typeof VISUAL_CONFIGS].width}' × 
// //               {VISUAL_CONFIGS[roomType as keyof typeof VISUAL_CONFIGS].depth}' × 
// //               {VISUAL_CONFIGS[roomType as keyof typeof VISUAL_CONFIGS].height}'
// //             </p>
// //           </div>
// //           <span className="bg-gray-700 text-gray-300 px-1.5 py-0.5 rounded text-[7px] font-semibold">
// //             Fixed
// //           </span>
// //         </div>

// //         {/* Calculation Dimensions */}
// //         <div className="bg-blue-900/40 rounded p-1.5 border border-blue-500/40">
// //           <div className="flex items-center justify-between mb-1">
// //             <p className="text-[8px] text-blue-300 uppercase tracking-wide">Calculating For</p>
// //             {hasCustomCalculationDims(roomType || 'kitchen') && (
// //               <span className="bg-blue-500 text-white px-1.5 py-0.5 rounded text-[7px] font-bold animate-pulse">
// //                 Custom
// //               </span>
// //             )}
// //           </div>
// //           <p className="text-white text-[12px] font-bold mb-1">
// //             {calculationDims.width}' × {calculationDims.depth}' × {calculationDims.height}'
// //           </p>
// //           <div className="flex gap-1">
// //             <button
// //               onClick={() => setShowCalculationDimEditor(true)}
// //               className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded text-[8px] font-semibold transition-all"
// //             >
// //               ✏️ Edit
// //             </button>
// //             {hasCustomCalculationDims(roomType || 'kitchen') && (
...
// //         </div>
// //       </div>
// // {/* ✅ NEW: CALCULATION DIMENSION EDITOR */}
...
// //       {/* Rest of the calculator section remains same... */}
...
// //                 <li className="flex items-start gap-1">
// //   <span className="text-purple-400 flex-shrink-0">🧮</span>
// //   <span>Universal calculator for any room</span>
// // </li>
// //               </ul>
// //             </div>
...
// //     onClose={() => setShowTileCalculator(false)}
// //     tileName={tile.name}
// //     tileSize={tile.size}
...
//   scalePatternCount
// } from '../utils/dimensionHelpers';
// import { calculateTiles } from '../utils/tileCalculations'; // ✅ ADD THIS LINE
// // ═══════════════════════════════════════════════════════════════
// // TYPESCRIPT INTERFACES
// // ═══════════════════════════════════════════════════════════════
...
// //   // ✅ Calculate for each wall height using AREA method
// //   if (perimeter > 0) {
// //     [5, 8, 11].forEach(height => {
// //       const wallArea = perimeter * height;
// //       const tilesNeeded = Math.ceil(wallArea / tileAreaSqFt);
...
//   // ✅ NEW: Calculation dimensions state
//   const [calculationDims, setCalculationDims] = useState<RoomDimensions | null>(null);
//   const [showCalculationDimEditor, setShowCalculationDimEditor] = useState(false);
//   const [showTileCalculator, setShowTileCalculator] = useState(false);
...
//   // ✅ NEW: Handle calculation dimension updates
//   // const handleCalculationDimensionUpdate = useCallback((width: number, depth: number, height: number) => {
//   //   const newDims = { width, depth, height };
...
// //   if (saved) {
// //     // Update local state - this will trigger recalculation
// //     setCalculationDims(newDims);
// //     setShowCalculationDimEditor(false);
...
// //     console.log('✅ Dimensions saved and state updated');
// //   } else {
// //     setError('Failed to save calculation dimensions');
...
//   if (saved) {
//     // ✅ Update local state with brand new object reference
//     setCalculationDims({ ...newDims });
    
//     // ✅ Increment version to force re-calculation
//     setDimsVersion(prev => {
...
//     // ✅ Verify update after a brief delay
//     setTimeout(() => {
...
//     console.error('❌ Failed to save dimensions to localStorage');
//   }
// }, [roomType, calculationDims]); // ✅ CHANGED: Added calculationDims to dependencies
//   const handleShare = useCallback(async () => {
//     const shareData = {
//       title: `${tile?.name} in ${roomType}`,
//       text: `Check out this tile visualization!`,
...
//   // EFFECTS
//   // ═════════════════════════════════════════════════════════════
// // ✅ Load calculation dimensions on mount
// useEffect(() => {
//   const dims = getCalculationDimensions(roomType || 'kitchen');
//   setCalculationDims(dims);
...
//     version: dimsVersion
//   });
// }, [roomType, dimsVersion]); // ✅ CHANGED: Added dimsVersion dependency
//   // ✅ NEW: Load calculation dimensions on mount
//   // useEffect(() => {
//   //   const dims = getCalculationDimensions(roomType || 'kitchen');
//   //   setCalculationDims(dims);
//   //   console.log('📐 Loaded calculation dimensions:', dims);
...
//   // ✅ UPDATED: Calculate tiles using CALCULATION dimensions
//   // useEffect(() => {
//   //   if (!calculationDims) return;
    
//   //   // Use CALCULATION dimensions (not visual)
//   //   const dims = calculationDims;
    
//   //   if (floorTile.size && floorTile.size.width > 0 && floorTile.size.height > 0) {
//   //     const floorCalc = calculateTileCount(
//   //       dims.width,      // ✅ Use calculation dims
//   //       dims.depth,      // ✅ Use calculation dims
//   //       dims.height,     // ✅ Use calculation dims
//   //       floorTile.size.width,
//   //       floorTile.size.height,
//   //       undefined,
//   //       roomType
...
//   //     });
//   //   }
//   // }, [floorTile.size, wallTile.size, roomType, calculationDims]); // ✅ Added calculationDims dependency

// // ✅ NEW: Calculate tiles using shared utility function
// // useEffect(() => {
// //   if (!calculationDims) {
// //     console.warn('⚠️ No calculation dimensions available');
// //     return;
// //   }

// //   if (!floorTile.size || floorTile.size.width <= 0 || floorTile.size.height <= 0) {
// //     console.warn('⚠️ Invalid floor tile size');
// //     return;
// //   }

// //   console.log('🔄 RECALCULATING TILES...', {
// //     calculationDims,
...
// //   console.log('✅ TILE COUNT UPDATED:', {
// //     floor: floorResult.floor,
// //     wall_5ft: wallData.wall_5ft,
// //     wall_8ft: wallData.wall_8ft,
// //     wall_11ft: wallData.wall_11ft
...
// // }, [calculationDims, floorTile.size, wallTile.size, wallTile.texture, roomType]);
  

// // ✅ ENHANCED: Calculate tiles using shared utility with version tracking
// useEffect(() => {
...
// }, [calculationDims, floorTile.size, wallTile.size, wallTile.texture, roomType, dimsVersion]); // ✅ CHANGED: Added dimsVersion
...
//   // Debug log for tile calculations
//   useEffect(() => {
//     if (wallTile.texture && highlighterBreakdown) {
//       console.log('🔍 TILE CALCULATION DEBUG:', {
//         selectedHeight: wallTileHeight,
...
//     }));
//   }}
//   calculationDimensions={calculationDims} // ✅ ADD: Pass calculation dimensions as prop
// /> */}
...
//     role: verifiedUser.role,
//     user_id: verifiedUser.uid,
//     seller_id: verifiedUser.seller_id,  // ✅ CHANGED: Use seller_id instead of showroom_id
//   } : undefined}
//   wallTileHeight={wallTileHeight}
//   highlightTileBorders={highlightTileBorders}
//   onHighlighterUpdate={(wall: WallType, indices: number[]) => {
...
//     }));
//   }}
//   calculationDimensions={calculationDims || undefined}  // ✅ CHANGED: Convert null to undefined
// />
...
//             {/* ═══════════════════════════════════════════════════════ */}
//             {/* ✅ TILE CALCULATOR SECTION WITH DUAL DIMENSIONS */}
//             {/* ═══════════════════════════════════════════════════════ */}
//             {tileCount && calculationDims && (
//               <section className="bg-gradient-to-br from-green-900/50 to-emerald-900/50 rounded-lg p-2 border-2 border-green-500/40">
//                 <button
...
//                 <li className="flex items-start gap-1">
//                   <span className="text-purple-400 flex-shrink-0">🧮</span>
//                   <span>Dual dimension system (visual + calculation)</span>
//                 </li>
//                 <li className="flex items-start gap-1">
//                   <span className="text-blue-400 flex-shrink-0">📐</span>
//                   <span>Universal calculator for any room</span>
...
//     isOpen={showTileCalculator}
//     onClose={() => {
//       console.log('🔄 Universal Calculator closed, reloading dimensions...');
      
//       // Close modal
//       setShowTileCalculator(false);
      
//       // Reload latest dimensions from localStorage
...
//         // ✅ Increment version to force recalculation
//         setDimsVersion(prev => prev + 1);
        
//         setSuccess('🔄 Dimensions synced from Universal Calculator');
//       } else {
