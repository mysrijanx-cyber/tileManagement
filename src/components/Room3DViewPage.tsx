...
// // // //   Package, AlertCircle, CheckCircle, X, Info,
// // // //   ChevronDown, ChevronUp, Eye, 
// // // //   Grid3x3, Settings, Shuffle, Highlighter, Upload, QrCode, Image as ImageIcon
// // // // } from 'lucide-react';
// // // // import { Enhanced3DViewer } from '../components/Enhanced3DViewer';
// // // // import { QRScanner } from '../components/QRScanner';
...
// // // //       navigator.vibrate([100, 50, 100]);
// // // //     }
// // // //   }, [tempFloorTileSize, floorTile.sellerId]);
...
// // // //                 <div className="bg-gray-800 rounded p-1.5 border border-gray-700">
// // // //                   <div className="flex items-center gap-1.5">
// // // //                     <img src={floorTile.texture || tile.imageUrl} alt={floorTile.tileName || tile.name} className="w-10 h-10 object-cover rounded ring-2 ring-blue-500/50" />
// // // //                     <div className="flex-1 min-w-0">
// // // //                       <p className="text-white font-medium text-[10px] truncate">{floorTile.tileName || tile.name}</p>
// // // //                       <p className="text-gray-400 text-[9px]">{tile.size}</p>
...
// // //                         {floorTile.size ? `${floorTile.size.width}×${floorTile.size.height}cm` : tile.size}
// // //                       </p>
...
// //             {/* FLOOR TILE SECTION - Display Only */}
// //             <section className="bg-gray-900/50 rounded-lg p-2 border-2 border-blue-500/30">
// //               <button
// //                 onClick={() => toggleSection('floor')}
// //                 className="w-full flex items-center justify-between mb-1.5 lg:cursor-default"
...
// //             {/* WALL TILE SECTION - With Floor Tile Change Button */}
// //             {isKitchenOrBathroom && (
// //               <section className="bg-gray-900/50 rounded-lg p-2 border-2 border-purple-500/30">
// //                 <button
// //                   onClick={() => toggleSection('wall')}
...
// //                   {/* Change Floor Tile Button - Inside Wall Section */}
...
// //                       Change Floor Tile
// //                     </button>
// //                     <div className="bg-amber-900/30 rounded p-1.5 border border-amber-500/30 mt-1.5">
...
//             {/* 🆕 TILE CALCULATOR SECTION - Universal for All Room Types */}
